...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBCuraPoolSize, Value: strconv.Itoa(DefTiDBCuraPoolSize)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBCuraPoolSizePerThread, Value: strconv.Itoa(DefTiDBCuraPoolSize)},
