...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBCuraConcurrentInputSource, Value: BoolToIntStr(DefTiDBCuraConcurrentInputSource)},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBCuraMemResSize, Value: strconv.Itoa(DefTiDBCuraMemResSize)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBCuraMemResSizePerThread, Value: strconv.Itoa(DefTiDBCuraMemResSize)},
