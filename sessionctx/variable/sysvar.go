...
var defaultSysVars = []*SysVar{
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBEnableCuraExec, Value: BoolToOnOff(DefTiDBEnableCuraExec)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBCuraConcurrentInputSource, Value: BoolToOnOff(DefTiDBCuraConcurrentInputSource)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBCuraStreamConcurrency, Value: strconv.Itoa(DefTiDBCuraStreamConcurrency)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBCuraChunkSize, Value: strconv.Itoa(DefTiDBCuraChunkSize)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBCuraSupport, Value: strconv.Itoa(DefTiDBCuraSupport)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBCuraMemoryResourceType, Value: strconv.Itoa(int(DefTiDBCuraMemResType))},
	...
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBCuraExclusiveDefaultMemoryResource, Value: BoolToOnOff(DefTiDBCuraExclusiveDefaultMemRes)},
	{Scope: ScopeGlobal | ScopeSession, Name: TiDBCuraEnableBucketAgg, Value: BoolToOnOff(DefTiDBCuraEnableBucketAgg)},
