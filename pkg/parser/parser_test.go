...
func TestMaterializedViewStatements(t *testing.T) {
	table := []testCase{
		...
		{
			"REFRESH MATERIALIZED VIEW mv COMPLETE INCREMENTAL UPDATE",
			true,
			"REFRESH MATERIALIZED VIEW `mv` COMPLETE INCREMENTAL UPDATE",
		},
		{
			"REFRESH MATERIALIZED VIEW mv WITH ASYNC MODE COMPLETE INCREMENTAL UPDATE",
			true,
			"REFRESH MATERIALIZED VIEW `mv` WITH ASYNC MODE COMPLETE INCREMENTAL UPDATE",
		},
		{
			"REFRESH MATERIALIZED VIEW mv COMPLETE INCREMENTAL UPDATE DRY RUN",
			true,
			"REFRESH MATERIALIZED VIEW `mv` COMPLETE INCREMENTAL UPDATE DRY RUN",
		},
		{
			"REFRESH MATERIALIZED VIEW mv COMPLETE INCREMENTAL UPDATE WITH PROFILE",
			true,
			"REFRESH MATERIALIZED VIEW `mv` COMPLETE INCREMENTAL UPDATE WITH PROFILE",
		},
		{
		...
		{
			"REFRESH MATERIALIZED VIEW mv FAST INCREMENTAL UPDATE",
			false,
			"",
		},
		{
			"REFRESH MATERIALIZED VIEW mv COMPLETE OUT OF PLACE INCREMENTAL UPDATE",
			false,
			"",
		},
	}
