...
const (
	...
	TypeDelete = "Delete"
	// TypeMViewDeltaMerge is the type of MV fast-refresh merge.
	TypeMViewDeltaMerge = "MViewDeltaMerge"
	// TypeMViewCompleteDeltaApply is the type of complete delta MV apply.
...
const (
	...
	typeMViewDeltaMergeID         int = 65
	typeMViewCompleteDeltaApplyID int = 66
)
...
func TypeStringToPhysicalID(tp string) int {
	...
	case TypeMViewCompleteDeltaApply:
		return typeMViewCompleteDeltaApplyID
...
func PhysicalIDToTypeString(id int) string {
	...
	case typeMViewCompleteDeltaApplyID:
