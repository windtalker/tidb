...
// DropMaterializedView rejects MV deletion because the schema tracker does not support MVs.
...
// DropMaterializedViewLog rejects MV log deletion because the schema tracker does not support MV logs.
