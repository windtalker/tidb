...
func (e *executor) resolvePurgeMaterializedViewLogMeta(
...
func purgeMaterializedViewLogData(
	...
	return int64(ddlSe.GetSessionVars().StmtCtx.AffectedRows()), nil
}
...
func (e *executor) PurgeMaterializedViewLog(ctx sessionctx.Context, s *ast.PurgeMaterializedViewLogStmt) (err error) {
	schemaName, baseTableMeta, mlogName, mlogID, err := e.resolvePurgeMaterializedViewLogMeta(ctx, s)
	if err != nil {
		return err
	}
