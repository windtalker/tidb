...
func (e *executor) alterMaterializedViewRefresh(
	...
	if updated && nextTime == nil {
		return errors.Trace(e.deleteMaterializedViewRefreshAlert(ctx, mviewID))
	}
	return nil
}
...
func (e *executor) deleteMaterializedViewRefreshAlert(ctx sessionctx.Context, mviewID int64) error {
	...
	if _, err := ddlSess.Execute(kctx, deleteSQL, "alter-materialized-view-refresh-delete-alert"); err != nil {
