...
func InitMVMetrics() {
	MVServiceTaskStatusGaugeVec = metricscommon.NewGaugeVec(
	...
	MVServiceOperationDurationHistogramVec = metricscommon.NewHistogramVec(
	...
	MVServiceRunEventCounterVec = metricscommon.NewCounterVec(
